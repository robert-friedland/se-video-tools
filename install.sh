...
# Download resolve_phrases script
echo "Downloading resolve_phrases..."
curl -fsSL "${GITHUB_RAW_BASE}/resolve_phrases.sh" -o "$INSTALL_DIR/resolve_phrases.sh"
chmod +x "$INSTALL_DIR/resolve_phrases.sh"
